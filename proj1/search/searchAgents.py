...
def find(map, vertice):
    if map[vertice] == vertice:
        return vertice
    return find(map, map[vertice])
...
def cornersHeuristic(state, problem):
    ...
    vertices = [x for x in problem.corners if x not in visitedCorners]
    vertices.append(currState)
    edges = PriorityQueue()
    map = {}
    ...
    return w # Default to trivial solution
